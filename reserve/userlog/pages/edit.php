...
if (isset($_GET['id'])) {
    $recordId = $_GET['id'];
    $selectSql = "SELECT id, name, Time, time_out FROM unitlogs WHERE id = $recordId";
...
if (isset($_POST['time_in_button'])) {
    $updateSql = "UPDATE unitlogs SET Time = '0000-00-00 00:00:00' WHERE id = $recordId";
...
if (isset($_POST['time_out_button'])) {
    $updateSql = "UPDATE unitlogs SET time_out = '0000-00-00 00:00:00' WHERE id = $recordId";
    $mysqli->query($updateSql);
...
if (isset($_POST['update'])) {
    ...
    $updateSql = "UPDATE unitlogs SET name = '$unitNumber', Time = '$timeIn', time_out = '$timeOut' WHERE id = $recordId";
    ...
    if ($mysqli->query($updateSql) === TRUE) {
        ...
        echo '<script>window.location.href = "/TRACK-WISE/admin2/pages/unitlogs.php";</script>';
        exit();
    } else {
    ...
    <main class="dashboard">
        ...
        <div class="container-fluid">
			...
			<button type="button" class="logout-button" >Time Out</button>
                <br>
                <br>
                <a href="unitlogs.php"><button type="button">Back</button></a> 
            </form>
        </div>
    </main>
        ...
        function updateTime(buttonType) {
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
					...
					window.location.href = "/TRACK-WISE/admin2/pages/unitlogs.php"; // Redirect after updating
                }
            };
