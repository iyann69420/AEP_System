...
if (isset($_POST['submit'])) {
    ...
    $check_sql = "SELECT id FROM adminlogs WHERE email = '$email'";
    ...
    if ($result->num_rows > 0) {
        ...
        $insert_sql = "INSERT INTO adminlogs (full_name, email, password, time_in, time_out) VALUES ('$full_name', '$email', '$password', '$time_in', '$time_out')";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="adminlogs.php" enctype="multipart/form-data">
                        <div class="">
